...
awful.spawn.with_shell([[
    sed -i 's/*rxyhn/*gruvbox/;s/*everforest/*gruvbox/;s/*nord/*gruvbox/' ]] .. alacrittycfg .. [[
]])
...
awful.spawn.with_shell([[
    sed -i 's/Everforest-Dark-BL/Gruvbox/;s/Nordic/Gruvbox/;s/Aesthetic-Night/Gruvbox/' ]] .. alacrittycfg .. [[
]])
